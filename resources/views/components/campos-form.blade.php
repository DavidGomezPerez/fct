...
<div class="relative">
    <input type="{{ $type }}" id="{{ $name }}" name="{{ $name }}" class="peer w-full border border-gray-300 rounded-md px-3 pt-5 pb-2 focus:border-blue-500 focus:ring-blue-500 focus:outline-none" placeholder=" " value="{{ $value }}" required>

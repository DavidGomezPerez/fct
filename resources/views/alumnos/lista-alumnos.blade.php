...
@section('content')
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="container flex justify-start mb-3">
            <div class="mr-5">
                <a href="{{ route("showAnyadirAlumno") }}" class="flex items-center w-full px-4 py-2 bg-green-600 text-white font-semibold rounded-lg shadow-md hover:bg-green-800 transition duration-300">
            ...
            <div class="w-2/3">
                <form action="{{ route("searchAlumnos") }}" method="GET" class="flex justify-center w-full max-w-md">
                    @csrf
                    <input type="search" name="search" placeholder="Buscar por nombre, apellidos, NIF, etc." class="px-4 py-2 border border-gray-300 rounded-md mr-2 w-full focus:border-blue-500 ring-blue-500 outline-none">
